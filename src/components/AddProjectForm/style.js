...
const AddProjectTitleStyle = styled.h2`
font-weight: 600;
font-size: 18px;
line-height: 23px;
color: #F2EDEB;
...
const AddProjectContainerStyle = styled.div`
  margin-top: 25px;
  width: 295px;
`;
...
const SaveButtonStyle = styled.button`
  ...
  border-color: transparent;
`;
export {AddProjectWrapper, AddProjectTitleStyle, SaveButtonStyle, TitleStyle, BasicInputStyle, AddProjectStyle, AddProjectContainerStyle};